...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<pdf-core>.freeze, ["~> 0.9.0"])
    s.add_runtime_dependency(%q<ttfunk>.freeze, ["~> 1.7"])
    ...
    s.add_dependency(%q<pdf-core>.freeze, ["~> 0.9.0"])
    s.add_dependency(%q<ttfunk>.freeze, ["~> 1.7"])
