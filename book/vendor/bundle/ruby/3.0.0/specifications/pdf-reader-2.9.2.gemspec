# -*- encoding: utf-8 -*-
# stub: pdf-reader 2.9.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/yob/pdf-reader/issues", "changelog_uri" => "https://github.com/yob/pdf-reader/blob/v2.9.2/CHANGELOG", "documentation_uri" => "https://www.rubydoc.info/gems/pdf-reader/2.9.2", "source_code_uri" => "https://github.com/yob/pdf-reader/tree/v2.9.2" } if s.respond_to? :metadata=
